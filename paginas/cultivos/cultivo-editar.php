    ...
    <div class="text-center">
        ...
        <div class="row" id="cuerpo">
            <div class="col-lg-9 col-md-12 order-2 order-lg-1 pt-5" id="contenido">
                    ...
                    <div class="container text-center">
                        <div class="row text-dark">
                            ...
                            <div class="col-lg-4 col-md-12 py-3">
                                ...
                                <select id="Temporadas" class="form-select">
                                    <?php
                                    $sql = "SELECT DISTINCT Temporada FROM `cultivos`;";
                                    require('../../herramientas/rellenar.php')
                                    ?>
                                </select>
                                <div class="row pt-3">
                ...
                generarTabla("SELECT * FROM Cultivos", "Cultivos", ['Parcela', 'Temporada']);
                ?>
                <div class="row">
                    <div class="col-9">
                    ...
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        submitBtn.addEventListener("click", function() {
                            ...
                            rows.forEach(function(row) {
                                ...
                                if (rowData.length > 0) {
                                    sql = `UPDATE Cultivos SET Genero = '${rowData[0]}', CantidadPlanta = '${rowData[3]}', Nombre = '${rowData[4]}' WHERE Parcela = '${rowData[1]}' AND Temporada = '${rowData[2]}'`;
                                    data.push(sql);
                                }
                            });
